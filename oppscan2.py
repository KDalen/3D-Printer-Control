...
from PyQt5.QtGui import QFont, QPainter, QImage, QStandardItemModel, QStandardItem
...
class MyApp(BaseUiClass, QtWidgets.QMainWindow):  # inherit all properties from QMainWindow class
    ...
    def __init__(self):  # this init part runs every time an object of MainWin is created
        """
        ...
        self.Printer = printer.console_control() # Calls class for printer
        ...
        self.camThread = camera.CamThread()
        self.camThread.frame_ready.connect(self.update_frame)
